 ...
 this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        pessoasTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Telefone", "Telefone Comercial"
            }
        ) {
        ...
        if (pessoasTable.getColumnModel().getColumnCount() > 0) {
            ...
            pessoasTable.getColumnModel().getColumn(0).setPreferredWidth(20);
        }
...
// ativa janela para editar dados da pessoa selecionada
 ...
 Pessoa nova = new Pessoa(p.getId(), p.getNome(), p.getFone()); 
...
buscaNomesTelefones((String)model.getValueAt(rowView, 0));
 ...
 for (Pessoa p : dados)
 {
 model.addRow(new Object[]{p.getId(), p.getNome(), p.getFoneFormatado()});// add os 3 campos em pessoa , que é add na lista, 
                                                                          // que depois joga na tabela da tela gráfica
