 ...
 /**
    ...
    private void initComponents() {
        ...
        if (produtosTable.getColumnModel().getColumnCount() > 0) {
            ...
            produtosTable.getColumnModel().getColumn(1).setMinWidth(110);
            produtosTable.getColumnModel().getColumn(1).setPreferredWidth(110);
            produtosTable.getColumnModel().getColumn(1).setMaxWidth(110);
        ...
        novoProdutoMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.ALT_MASK));
 ...
 */
 ...
 ArrayList<Produto> lista = buscaNomesTelefones2((String)model.getValueAt(rowView, 2));
...
//==============================================================================
    ...
    public ArrayList<Produto> buscaNomesTelefones2(String procurado)
    {
...
//==============================================================================
    ...
    {
  ArrayList<Produto> filtro = buscaNomesTelefones2(filtroTextField.getText());
 mostraDados(filtro);
