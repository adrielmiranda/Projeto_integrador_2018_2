...
//==============================================================================
    ...
    private void initComponents() {
        ...
        if (vendasTable.getColumnModel().getColumnCount() > 0) {
            ...
            vendasTable.getColumnModel().getColumn(1).setMinWidth(80);
            vendasTable.getColumnModel().getColumn(1).setPreferredWidth(80);
            vendasTable.getColumnModel().getColumn(1).setMaxWidth(80);
            vendasTable.getColumnModel().getColumn(2).setMinWidth(140);
            vendasTable.getColumnModel().getColumn(3).setMinWidth(200);
            vendasTable.getColumnModel().getColumn(4).setMinWidth(110);
            vendasTable.getColumnModel().getColumn(4).setPreferredWidth(110);
            vendasTable.getColumnModel().getColumn(4).setMaxWidth(110);
            vendasTable.getColumnModel().getColumn(6).setMinWidth(100);
            vendasTable.getColumnModel().getColumn(6).setPreferredWidth(100);
            vendasTable.getColumnModel().getColumn(6).setMaxWidth(100);
        }
        ...
        novaVendaMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D, java.awt.event.InputEvent.ALT_MASK));
...
//==============================================================================
 ...
 for (Venda p : dados)
 {                                                                          //=-=-=-=-=-=-=-=-=-//=-=-=-=-=-=-=-=-=-
 model.addRow(new Object[]{p.getId(), p.getNF() , p.getNomeProduto()  });// aqui tem q por na ordem que vai aparecer no grid
