 ...
 this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        if (pessoasTable.getColumnModel().getColumnCount() > 0) {
            pessoasTable.getColumnModel().getColumn(0).setMinWidth(20);
            ...
            pessoasTable.getColumnModel().getColumn(6).setMinWidth(80);
            pessoasTable.getColumnModel().getColumn(6).setPreferredWidth(80);
            pessoasTable.getColumnModel().getColumn(6).setMaxWidth(80);
        ...
        novaPessoaMenuItem.setText("Novo Produto");
...
// ativa janela para editar dados da pessoa selecionada
 TelaCadastroProduto pDialog = new TelaCadastroProduto(this, true);
 ...
 Produto novo = new Produto(p.getId(), p.getNome(), p.getFone(), p.getFone_Comercial(), p.getFone_Residencial(), p.getCPF(),
...
buscaNomesTelefones((String)model.getValueAt(rowView, 2));
 ...
 Produto selecionada = lista.get(0);
 ...
 listaProdutos.remove(selecionada);
